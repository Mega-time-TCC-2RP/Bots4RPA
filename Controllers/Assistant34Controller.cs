...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant34Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant34Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess34 _program = new AssistantProcess34();
        _program.Play();
        _AssistantRepository.EnviaEmail(34,assistant);
