...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant35Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant35Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess35 _program = new AssistantProcess35();
        _program.Play();
        _AssistantRepository.EnviaEmail(35,assistant);
