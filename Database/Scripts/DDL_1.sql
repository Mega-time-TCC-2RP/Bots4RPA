...
create table Task(
        ...
        --add the foreign keys
        IdFuncionario INT FOREIGN KEY REFERENCES Funcionario(IdEmpresa),
...
create table Comment(
        ...
        CommentDescription varchcar(max),
        DataComment DateTime,
        --CommentImages text

        --foreign keys
        IdPost INT FOREIGN KEY REFERENCES Post(IdPost),
        IdJogador INT FOREIGN KEY REFERENCES Jogador(IdPost)
);
GO
