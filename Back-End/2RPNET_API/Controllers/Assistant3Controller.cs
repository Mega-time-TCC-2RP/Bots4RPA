...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant3Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant3Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess3 _program = new AssistantProcess3();
        _program.Play();
        _AssistantRepository.EnviaEmail(3,assistant);
