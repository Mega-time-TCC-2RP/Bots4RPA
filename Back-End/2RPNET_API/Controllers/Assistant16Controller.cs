...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant16Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant16Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess16 _program = new AssistantProcess16();
        _program.Play();
        _AssistantRepository.EnviaEmail(16,assistant);
