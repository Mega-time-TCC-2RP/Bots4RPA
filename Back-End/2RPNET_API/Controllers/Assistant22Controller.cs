...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant22Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant22Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess22 _program = new AssistantProcess22();
        _program.Play();
        _AssistantRepository.EnviaEmail(22,assistant);
