...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant118Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant118Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess118 _program = new AssistantProcess118();
        _program.Play();
        _AssistantRepository.EnviaEmail(118,assistant);
