...
namespace _2RPNET_API.Controllers
{
    ...
    [ApiController]
    public class Assistant54Controller : ControllerBase{
        private IAssistantRepository _AssistantRepository { get; set; }

        public Assistant54Controller(IAssistantRepository Assistant)
        {
...
public IActionResult NewRun(SendEmailViewModel assistant)
{
    try
    {
AssistantProcess54 _program = new AssistantProcess54();
        _program.Play();
        _AssistantRepository.EnviaEmail(54,assistant);
