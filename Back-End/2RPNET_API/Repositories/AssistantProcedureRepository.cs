...
Console.WriteLine(message.Text);");
                                break;
                            case "Enviar email":
                                sw2.WriteLine(@"AssistantRepository assistantRepository = new AssistantRepository();");
                                sw2.WriteLine(@"assistantRepository.EnviaEmail((int idAssistant, SendEmailViewModel emailConfig);");
                                break;
